...
f=open('diseases.txt','r',errors = 'ignore')
m=open('doctors.txt','r',errors = 'ignore')
...
wel_msg="Hi I am Docbot. Based on your symptoms I will predict your disease and also suggest analgesics,treatment and diet for the predicted disease"
GREETING_RESPONSES = ["So tell me are you facing any health issues", "So tell me are you facing any health issues"]
Basic_Q = ("yes","y")
...
def response(user_response):
    ...
    req_tfidf = flat[-2]
    if(req_tfidf==0):
        robo_response=robo_response+"I am sorry! I didn't understand you. Please be clear"
...
def chat(user_response):
    ...
    if(user_response!='bye'):
        ...
        flag=False
        return "Bye! take care. Stay safe"
